...
// Proteção: Apenas clientes logados podem ver o carrinho
...
if (!empty($cart_product_ids)) {
    // Conta a quantidade de cada produto (pelo número de vezes que o ID aparece)
    ...
    // Busca os detalhes de todos os produtos no carrinho com uma única consulta
    $sql = "SELECT id_produto, name, price, image FROM Produto WHERE id_produto IN ($placeholders)";
